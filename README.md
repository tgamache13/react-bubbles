...
- [ ] Explain what a token is used for.
  ...
  A token is used for authorization to access protected content from an API server.

- [ ] What steps can you take in your web apps to keep your data secure?

Make routes private that have sensitive data and use axiosWithAuth utility to require a token to make requests.

- [ ] Describe how web servers work.

Web servers listen for requests and respond with the requested information.
